import {
  ...
  import ObjectParameterProps from './objectParameterProps';
  
  import { without } from 'min-dash';
  
  
  export default function ObjectParametersProps({ element, injector }) {
  ...
  function addFactory({ element, bpmnFactory, commandStack }) {
    return function(event) {
      ...
      // (3) create parameter
      const newParameter = createElement('dataObject:Parameter', {
